...
[Mindustry](https://github.com/Anuken/Mindustry) Java mod conceptm, otherwise known as JAR-modding, complete with [`EntityAnno`](https://github.com/GglLfr/EntityAnno) and syntax downgrader integration, works for both Android and PC.
