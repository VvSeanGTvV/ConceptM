package conceptm.world.blocks.campaign;
...
import arc.util.*;
import conceptm.world.meta.Stat;
...
import static conceptm.ConceptMod.getStatBundle;
import static conceptm.ui.UIExtended.fdelta;
...
public class NewAccelerator extends Block {
    ...
    public void setStats() {
        ...
        stats.add(Stat.launchSector, table -> {
            table.row();
            table.table(Styles.grayPanel, t -> {
                t.table(infoSector -> {
                    infoSector.add(getStatBundle.get("launch-destination")).row();
                ...
                t.table(info -> {
                    info.add(bundle.get("stat.launchtime")).row();
